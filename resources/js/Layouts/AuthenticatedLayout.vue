    ...
    <div class="min-w-[1150px] bg-gray-100 h-full">
        ...
        <div class="flex items-center bg-gray-900 h-[60px] py-2 fixed z-50 min-w-[1150px] w-full">
            ...
            <div class="flex">
                ...
                <Link href="/" class="relative h-[50px] p-2 border-[1px] border-gray-900 rounded-sm hover:border-[1px] hover:border-gray-100 cursor-pointer">
                    <span class="absolute text-center right-[21px] w-[14px] -top-0 rounded-full text-[20px]">
                        <div class="text-orange-400 font-extrabold bg-gray-900 h-[16px]"></div>
                    </span>
                    <div class="flex items-center justify-center">
